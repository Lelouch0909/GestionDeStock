...
import com.lontsi.gestiondestock.repository.MvtStkRepository;
import com.lontsi.gestiondestock.services.ArticleService;
import com.lontsi.gestiondestock.services.MvtStkService;
import com.lontsi.gestiondestock.validator.MvtStkValidator;
...
public class MvtStkServiceImpl implements MvtStkService {
	...
	public List<MvtStkDto> mvtStkArticle(Integer idArticle) {
		return repository.findAllByArticleId(idArticle).stream().map(MvtStkDto::fromEntity)
	...
	private MvtStkDto entreePositive(MvtStkDto dto, TypeMvtStk typeMvtStk) {
		...
		if (!errors.isEmpty()) {
			...
			throw new InvalidEntityException("Le mouvement du stock n'est pas valide", ErrorsCodes.MVT_STK_NOT_VALID,
					errors);
		}
